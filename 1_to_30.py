...
# Loop through pages
page_number = 2350  # Start from page 1
max_pages = num_pages 
...
try:
    while page_number <= max_pages:
        ...
        ### Save DataFrame to CSV
            ...
            sas_url = f"https://autotraderstorage.blob.core.windows.net/carscoza/Carscoza_6_{page_number}.csv?sv=2023-01-03&st=2024-11-12T09%3A40%3A08Z&se=2025-12-13T09%3A40%3A00Z&sr=c&sp=racwl&sig=jAVH6gfSPsevwiQyFfJrW6voqdVbUS5Das0%2BulrJ9Z0%3D"
